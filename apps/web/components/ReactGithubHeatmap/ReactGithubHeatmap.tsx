...
export const ReactGithubHeatmap = ({
  ...
  const getTooltipContent = (date: Date) => {
    ...
    return tooltipContent(
      contribution as { date: string; contributions: number },
    );
  };
  ...
  return (
    <div className="contribution-graph__container">
      <div className="contribution-graph__table-wrapper">
        <table className="contribution-graph__table">
          ...
          <tbody>
            {dateGrid.map((row, rowIndex) => (
              <tr key={rowIndex} className="contribution-graph__week-row">
        ...
        <Tooltip id="tooltip" {...props.tooltipOptions} />
      </div>
      <div className="contribution-graph__legend">
        <span className="contribution-graph__legend-text">
